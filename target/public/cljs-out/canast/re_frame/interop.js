...
return [(function (){var pred__12910 = cljs.core.instance_QMARK_;
var expr__12911 = reactive_val;
if(cljs.core.truth_(pred__12910.call(null,reagent.ratom.RAtom,expr__12911))){
return "ra";
} else {
if(cljs.core.truth_(pred__12910.call(null,reagent.ratom.RCursor,expr__12911))){
return "rc";
} else {
if(cljs.core.truth_(pred__12910.call(null,reagent.ratom.Reaction,expr__12911))){
return "rx";
} else {
if(cljs.core.truth_(pred__12910.call(null,reagent.ratom.Track,expr__12911))){
return "tr";
} else {
return "other";
}
