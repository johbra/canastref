...
var len__4771__auto___16014 = arguments.length;
var i__4772__auto___16015 = (0);
while(true){
if((i__4772__auto___16015 < len__4771__auto___16014)){
args__4777__auto__.push((arguments[i__4772__auto___16015]));

var G__16016 = (i__4772__auto___16015 + (1));
i__4772__auto___16015 = G__16016;
continue;
} else {
}
break;
...
(re_com.text.label.cljs$core$IFn$_invoke$arity$variadic = (function (p__16012){
var map__16013 = p__16012;
var map__16013__$1 = cljs.core.__destructure_map(map__16013);
var args = map__16013__$1;
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,cljs.core.cst$kw$attr);
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,cljs.core.cst$kw$parts);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,cljs.core.cst$kw$width);
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,cljs.core.cst$kw$src);
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,cljs.core.cst$kw$on_DASH_click);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,cljs.core.cst$kw$style);
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,cljs.core.cst$kw$debug_DASH_as);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,cljs.core.cst$kw$label);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,cljs.core.cst$kw$class);
var or__4160__auto__ = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.text.label_args_desc),args));
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
return new cljs.core.PersistentVector(null, 17, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,cljs.core.cst$kw$debug_DASH_as,(function (){var or__4160__auto____$1 = debug_as;
...
/** @this {Function} */
(re_com.text.label.cljs$lang$applyTo = (function (seq16011){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16011));
}));
...
var args__4777__auto__ = [];
var len__4771__auto___16020 = arguments.length;
var i__4772__auto___16021 = (0);
while(true){
if((i__4772__auto___16021 < len__4771__auto___16020)){
args__4777__auto__.push((arguments[i__4772__auto___16021]));

var G__16022 = (i__4772__auto___16021 + (1));
i__4772__auto___16021 = G__16022;
continue;
} else {
}
break;
...
var margin_bottom = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__16019__$1,cljs.core.cst$kw$margin_DASH_bottom,"0.3em");
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16019__$1,cljs.core.cst$kw$attr);
var margin_top = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__16019__$1,cljs.core.cst$kw$margin_DASH_top,"0.6em");
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16019__$1,cljs.core.cst$kw$parts);
var underline_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16019__$1,cljs.core.cst$kw$underline_QMARK_);
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16019__$1,cljs.core.cst$kw$src);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16019__$1,cljs.core.cst$kw$level);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16019__$1,cljs.core.cst$kw$style);
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16019__$1,cljs.core.cst$kw$debug_DASH_as);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16019__$1,cljs.core.cst$kw$label);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16019__$1,cljs.core.cst$kw$class);
var or__4160__auto__ = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.text.title_args_desc),args));
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
var preset_class = (((level == null))?"":cljs.core.name(level));
return new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.v_box,cljs.core.cst$kw$src,src,cljs.core.cst$kw$debug_DASH_as,(function (){var or__4160__auto____$1 = debug_as;
if(cljs.core.truth_(or__4160__auto____$1)){
return or__4160__auto____$1;
} else {
return new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$component,re_com.debug.short_component_name(reagent.impl.component.component_name(reagent.core.current_component())),cljs.core.cst$kw$args,args], null);
}
})(),cljs.core.cst$kw$class,["rc-title-wrapper ",preset_class," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$wrapper,cljs.core.cst$kw$class], null)))].join(''),cljs.core.cst$kw$style,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$wrapper,cljs.core.cst$kw$style], null)),cljs.core.cst$kw$attr,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$wrapper,cljs.core.cst$kw$attr], null)),cljs.core.cst$kw$children,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$class,["display-flex rc-title ",preset_class," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$)].join(''),cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_com.box.flex_child_style("none"),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$margin_DASH_top,margin_top], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$line_DASH_height,(1)], null),(cljs.core.truth_(underline_QMARK_)?null:new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$margin_DASH_bottom,margin_bottom], null)),style], 0))], null),attr], 0)),label], null),(cljs.core.truth_(underline_QMARK_)?new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.line,cljs.core.cst$kw$src,(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$file,"/Users/jb/Documents/PRIVAT/canastapp/canastref/target/public/cljs-out/canast/re_com/text.cljs",cljs.core.cst$kw$line,114], null)),cljs.core.cst$kw$size,"1px",cljs.core.cst$kw$class,["rc-title-underline ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$underline,cljs.core.cst$kw$class], null)))].join(''),cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$margin_DASH_bottom,margin_bottom], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$underline,cljs.core.cst$kw$style], null))], 0)),cljs.core.cst$kw$attr,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$underline,cljs.core.cst$kw$attr], null))], null):null)], null)], null);
}
}));
...
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16017));
}));
...
var args__4777__auto__ = [];
var len__4771__auto___16027 = arguments.length;
var i__4772__auto___16028 = (0);
while(true){
if((i__4772__auto___16028 < len__4771__auto___16027)){
args__4777__auto__.push((arguments[i__4772__auto___16028]));

var G__16029 = (i__4772__auto___16028 + (1));
i__4772__auto___16028 = G__16029;
continue;
} else {
}
break;
...
var vec__16024 = ((cljs.core.map_QMARK_(child1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [child1,cljs.core.rest(children)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,children], null));
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16024,(0),null);
var children__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16024,(1),null);
...
/** @this {Function} */
(re_com.text.p.cljs$lang$applyTo = (function (seq16023){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16023));
}));
