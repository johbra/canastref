...
var G__20927_20928 = re_com.selection_list.check_clicked(selections,item_id,cljs.core.not((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id))),required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__20927_20928) : on_change.call(null,G__20927_20928));
}

return null;
})], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$list_DASH_group_DASH_item,cljs.core.cst$kw$attr], null))], 0)),cljs.core.cst$kw$child,new cljs.core.PersistentVector(null, 19, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.checkbox.checkbox,cljs.core.cst$kw$src,(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$file,"/Users/jb/Documents/PRIVAT/canastapp/canastref/target/public/cljs-out/canast/re_com/selection_list.cljs",cljs.core.cst$kw$line,52], null)),cljs.core.cst$kw$class,["rc-selection-list-checkbox ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$checkbox,cljs.core.cst$kw$class], null)))].join(''),cljs.core.cst$kw$style,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$checkbox,cljs.core.cst$kw$style], null)),cljs.core.cst$kw$attr,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$checkbox,cljs.core.cst$kw$attr], null)),cljs.core.cst$kw$model,(!(((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id)) == null))),cljs.core.cst$kw$on_DASH_change,(function (){
...
var len__4771__auto___20937 = arguments.length;
var i__4772__auto___20938 = (0);
while(true){
if((i__4772__auto___20938 < len__4771__auto___20937)){
args__4777__auto__.push((arguments[i__4772__auto___20938]));

var G__20939 = (i__4772__auto___20938 + (1));
i__4772__auto___20938 = G__20939;
continue;
} else {
}
break;
...
(re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__20935){
var map__20936 = p__20935;
var map__20936__$1 = cljs.core.__destructure_map(map__20936);
var args = map__20936__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20936__$1,cljs.core.cst$kw$disabled_QMARK_,false);
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$on_DASH_change);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$height);
var item_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$item_DASH_renderer);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$model);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$attr);
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20936__$1,cljs.core.cst$kw$label_DASH_fn,cljs.core.cst$kw$label);
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20936__$1,cljs.core.cst$kw$required_QMARK_,false);
var as_exclusions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20936__$1,cljs.core.cst$kw$as_DASH_exclusions_QMARK_,false);
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$max_DASH_height);
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20936__$1,cljs.core.cst$kw$hide_DASH_border_QMARK_,false);
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$parts);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$width);
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$src);
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$choices);
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20936__$1,cljs.core.cst$kw$id_DASH_fn,cljs.core.cst$kw$id);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$style);
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$debug_DASH_as);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20936__$1,cljs.core.cst$kw$class);
var multi_select_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20936__$1,cljs.core.cst$kw$multi_DASH_select_QMARK_,true);
var or__4160__auto__ = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.selection_list.selection_list_args_desc),args));
...
var items = cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(item_renderer__$1)?(function (p1__20931_SHARP_){
return (item_renderer__$1.cljs$core$IFn$_invoke$arity$8 ? item_renderer__$1.cljs$core$IFn$_invoke$arity$8(p1__20931_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1) : item_renderer__$1.call(null,p1__20931_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1));
}):(cljs.core.truth_(multi_select_QMARK___$1)?(function (p1__20932_SHARP_){
return re_com.selection_list.as_checked(p1__20932_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1,parts);
}):(function (p1__20933_SHARP_){
return re_com.selection_list.as_radio(p1__20933_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1,parts);
}))),choices__$1);
...
return new cljs.core.PersistentVector(null, 17, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.border,cljs.core.cst$kw$src,src,cljs.core.cst$kw$debug_DASH_as,(function (){var or__4160__auto____$1 = debug_as;
...
/** @this {Function} */
(re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq20934){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq20934));
}));
