...
re_com.simple_v_table.swap_BANG__sort_by_column = (function re_com$simple_v_table$swap_BANG__sort_by_column(p__20858,new_key_fn,new_comp){
var map__20859 = p__20858;
var map__20859__$1 = cljs.core.__destructure_map(map__20859);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20859__$1,cljs.core.cst$kw$key_DASH_fn);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20859__$1,cljs.core.cst$kw$order);
...
re_com.simple_v_table.column_header_item = (function re_com$simple_v_table$column_header_item(p__20860,parts,sort_by_column){
var map__20861 = p__20860;
var map__20861__$1 = cljs.core.__destructure_map(map__20861);
var column = map__20861__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20861__$1,cljs.core.cst$kw$id);
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20861__$1,cljs.core.cst$kw$row_DASH_label_DASH_fn);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20861__$1,cljs.core.cst$kw$width);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20861__$1,cljs.core.cst$kw$height);
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20861__$1,cljs.core.cst$kw$align);
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20861__$1,cljs.core.cst$kw$vertical_DASH_align);
var header_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20861__$1,cljs.core.cst$kw$header_DASH_label);
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20861__$1,cljs.core.cst$kw$sort_DASH_by);
var map__20862 = sort_by;
var map__20862__$1 = cljs.core.__destructure_map(map__20862);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20862__$1,cljs.core.cst$kw$key_DASH_fn,row_label_fn);
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20862__$1,cljs.core.cst$kw$comp,cljs.core.compare);
var map__20863 = cljs.core.deref(sort_by_column);
var map__20863__$1 = cljs.core.__destructure_map(map__20863);
var current_key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20863__$1,cljs.core.cst$kw$key_DASH_fn);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20863__$1,cljs.core.cst$kw$order);
...
return null;
})], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$simple_DASH_column_DASH_header,cljs.core.cst$kw$attr], null))], 0))], null),(function (){var iter__4564__auto__ = (function re_com$simple_v_table$column_header_renderer_$_iter__20864(s__20865){
...
var b__20867 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__20866 = (0);
while(true){
if((i__20866 < size__4563__auto__)){
var column = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4562__auto__,i__20866);
cljs.core.chunk_append(b__20867,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null));

var G__20868 = (i__20866 + (1));
i__20866 = G__20868;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20867),re_com$simple_v_table$column_header_renderer_$_iter__20864(cljs.core.chunk_rest(s__20865__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20867),null);
}
} else {
var column = cljs.core.first(s__20865__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null),re_com$simple_v_table$column_header_renderer_$_iter__20864(cljs.core.rest(s__20865__$2)));
}
} else {
return null;
}
...
return iter__4564__auto__(columns);
})());
});
/**
 * Render a single row item (column) of a single row
 */
re_com.simple_v_table.row_item = (function re_com$simple_v_table$row_item(row,p__20869,cell_style,parts){
var map__20870 = p__20869;
var map__20870__$1 = cljs.core.__destructure_map(map__20870);
var column = map__20870__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20870__$1,cljs.core.cst$kw$width);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20870__$1,cljs.core.cst$kw$height);
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20870__$1,cljs.core.cst$kw$align);
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20870__$1,cljs.core.cst$kw$vertical_DASH_align);
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20870__$1,cljs.core.cst$kw$row_DASH_label_DASH_fn);
...
return null;
}):null)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$simple_DASH_row,cljs.core.cst$kw$attr], null))], 0))], null),(function (){var iter__4564__auto__ = (function re_com$simple_v_table$row_renderer_$_iter__20871(s__20872){
return (new cljs.core.LazySeq(null,(function (){
...
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__20874 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__20873 = (0);
while(true){
if((i__20873 < size__4563__auto__)){
var column = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4562__auto__,i__20873);
cljs.core.chunk_append(b__20874,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null));

var G__20875 = (i__20873 + (1));
i__20873 = G__20875;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20874),re_com$simple_v_table$row_renderer_$_iter__20871(cljs.core.chunk_rest(s__20872__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20874),null);
}
} else {
var column = cljs.core.first(s__20872__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null),re_com$simple_v_table$row_renderer_$_iter__20871(cljs.core.rest(s__20872__$2)));
}
} else {
return null;
}
...
re_com.simple_v_table.simple_v_table_parts_desc = ((re_com.config.include_args_desc_QMARK_)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_com.simple_v_table.simple_v_table_exclusive_parts_desc,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20876_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__20876_SHARP_,cljs.core.cst$kw$level,cljs.core.inc);
...
return ((cljs.core.fn_QMARK_(p1__20877_SHARP_)) || (cljs.core.map_QMARK_(p1__20877_SHARP_)));
...
return ((cljs.core.fn_QMARK_(p1__20878_SHARP_)) || (cljs.core.map_QMARK_(p1__20878_SHARP_)));
...
var len__4771__auto___20886 = arguments.length;
var i__4772__auto___20887 = (0);
while(true){
if((i__4772__auto___20887 < len__4771__auto___20886)){
args__4777__auto__.push((arguments[i__4772__auto___20887]));

var G__20888 = (i__4772__auto___20887 + (1));
i__4772__auto___20887 = G__20888;
continue;
} else {
}
break;
...
(re_com.simple_v_table.simple_v_table.cljs$core$IFn$_invoke$arity$variadic = (function (p__20880){
var map__20881 = p__20880;
var map__20881__$1 = cljs.core.__destructure_map(map__20881);
var args = map__20881__$1;
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20881__$1,cljs.core.cst$kw$src);
var or__4160__auto__ = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.simple_v_table.simple_v_table_args_desc),args));
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
var sort_by_column = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
return (function() { 
var re_com$simple_v_table$simple_v_table_render__delegate = function (p__20882){
var map__20883 = p__20882;
var map__20883__$1 = cljs.core.__destructure_map(map__20883);
var args__$1 = map__20883__$1;
var cell_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$cell_DASH_style);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$model);
var on_leave_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$on_DASH_leave_DASH_row);
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$columns);
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$parts);
var on_enter_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$on_DASH_enter_DASH_row);
var row_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20883__$1,cljs.core.cst$kw$row_DASH_height,(31));
var max_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$max_DASH_width);
var src__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$src);
var on_click_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$on_DASH_click_DASH_row);
var table_row_line_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20883__$1,cljs.core.cst$kw$table_DASH_row_DASH_line_DASH_color,"#EAEEF1");
var table_padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20883__$1,cljs.core.cst$kw$table_DASH_padding,(19));
var column_header_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20883__$1,cljs.core.cst$kw$column_DASH_header_DASH_height,(31));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$debug_DASH_as);
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$max_DASH_rows);
var row_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$row_DASH_style);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20883__$1,cljs.core.cst$kw$class);
var fixed_column_border_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20883__$1,cljs.core.cst$kw$fixed_DASH_column_DASH_border_DASH_color,"#BBBEC0");
var column_header_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20883__$1,cljs.core.cst$kw$column_DASH_header_DASH_renderer,re_com.simple_v_table.column_header_renderer);
var fixed_column_count = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20883__$1,cljs.core.cst$kw$fixed_DASH_column_DASH_count,(0));
var or__4160__auto____$1 = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.simple_v_table.simple_v_table_args_desc),args__$1));
if(cljs.core.truth_(or__4160__auto____$1)){
return or__4160__auto____$1;
} else {
var fcc_bounded = (function (){var x__4252__auto__ = fixed_column_count;
var y__4253__auto__ = cljs.core.count(columns);
...
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20884__$1,cljs.core.cst$kw$order);
...
return new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,cljs.core.cst$kw$src,src__$1,cljs.core.cst$kw$debug_DASH_as,(function (){var or__4160__auto____$2 = debug_as;
...
while (G__20889__i < G__20889__a.length) {G__20889__a[G__20889__i] = arguments[G__20889__i + 0]; ++G__20889__i;}
  p__20882 = new cljs.core.IndexedSeq(G__20889__a,0,null);
} 
return re_com$simple_v_table$simple_v_table_render__delegate.call(this,p__20882);};
re_com$simple_v_table$simple_v_table_render.cljs$lang$maxFixedArity = 0;
re_com$simple_v_table$simple_v_table_render.cljs$lang$applyTo = (function (arglist__20890){
var p__20882 = cljs.core.seq(arglist__20890);
return re_com$simple_v_table$simple_v_table_render__delegate(p__20882);
});
...
/** @this {Function} */
(re_com.simple_v_table.simple_v_table.cljs$lang$applyTo = (function (seq20879){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq20879));
}));
