...
var periods__$1 = cljs.core.vec((function (){var G__20553 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20552_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__20552_SHARP_,(0),(3));
}),G__20553);
} else {
return G__20553;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__20562){
var vec__20563 = p__20562;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20563,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20563,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,cljs.core.cst$kw$token)){
var G__20566 = pattern;
switch (G__20566) {
case "S":
...
return p1__20568_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__20569_SHARP_){
return p1__20569_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__20570_SHARP_){
return p1__20570_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__20571_SHARP_){
return p1__20571_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__20572_SHARP_){
return p1__20572_SHARP_.getHours();
});

break;
case "day":
return (function (p1__20573_SHARP_){
return p1__20573_SHARP_.getDate();
});

break;
case "month":
return (function (p1__20574_SHARP_){
return p1__20574_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__20575_SHARP_){
return p1__20575_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20576__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__20578){
...
var key = first__20581;
var args = seq__20580__$1;
var G__20582 = key;
...
break;
case "ordinal-suffix":
var vec__20583 = (function (){var G__20586 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__20586) : syntax_list.call(null,G__20586));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20582__$1)].join('')));
...
var d = value;
var G__20591 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__20592 = G__20591;
...
var unparser = first__20594;
var more = seq__20593__$1;
var s = "";
var d__$1 = d;
...
while(true){
var d__$2 = d__$1;
var vec__20601 = G__20591__$1;
var seq__20602 = cljs.core.seq(vec__20601);
var first__20603 = cljs.core.first(seq__20602);
var seq__20602__$1 = cljs.core.next(seq__20602);
var unparser__$1 = first__20603;
var more__$1 = seq__20602__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__20604 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20604,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20604,(1),null);
var G__20607 = d__$3;
var G__20608 = more__$1;
var G__20609 = s__$3;
d__$1 = G__20607;
G__20591__$1 = G__20608;
s__$1 = G__20609;
continue;
}
break;
