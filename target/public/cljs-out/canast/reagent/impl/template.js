...
var G__12762 = o;
goog.object.set(G__12762,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__12763__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__12763 = function (var_args){
var args = null;
...
while (G__12764__i < G__12764__a.length) {G__12764__a[G__12764__i] = arguments[G__12764__i + 0]; ++G__12764__i;}
  args = new cljs.core.IndexedSeq(G__12764__a,0,null);
} 
return G__12763__delegate.call(this,args);};
G__12763.cljs$lang$maxFixedArity = 0;
G__12763.cljs$lang$applyTo = (function (arglist__12765){
var args = cljs.core.seq(arglist__12765);
return G__12763__delegate(args);
});
...
var G__12766 = o;
goog.object.set(G__12766,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__12767__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__12768__i < G__12768__a.length) {G__12768__a[G__12768__i] = arguments[G__12768__i + 0]; ++G__12768__i;}
  args = new cljs.core.IndexedSeq(G__12768__a,0,null);
} 
...
var args = cljs.core.seq(arglist__12769);
...
var G__12770 = props;
var G__12770__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__12770,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12770);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__12770__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4160__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__12771 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__12771,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__12771;
}
})(),id_class);
...
var G__12772 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12772) {
case (0):
...
var vec__12774 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12774,(0),null);
var id = cljs.core.nth.call(null,vec__12774,(1),null);
var className = cljs.core.nth.call(null,vec__12774,(2),null);
...
var temp__5757__auto___12777 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___12777 == null)){
} else {
var key_12778 = temp__5757__auto___12777;
(jsprops.key = key_12778);
}
...
var temp__5757__auto___12779 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___12779 == null)){
} else {
var key_12780 = temp__5757__auto___12779;
(jsprops.key = key_12780);
}
...
var temp__5757__auto___12781 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___12781 == null)){
} else {
var key_12782 = temp__5757__auto___12781;
(jsprops.key = key_12782);
}
...
var temp__5757__auto___12783 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___12783 == null)){
} else {
var key_12784 = temp__5757__auto___12783;
(jsprops.key = key_12784);
}
...
var temp__5757__auto___12785 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___12785 == null)){
} else {
var key_12786 = temp__5757__auto___12785;
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__12787_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__12787_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12788 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__12788,(0),null);
var derefed = cljs.core.nth.call(null,vec__12788,(1),null);
...
break;
default:
var G__12793 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__12794 = compiler;
v = G__12793;
compiler = G__12794;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template12798 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template12798 = (function (opts,id,fn_to_element,meta12799){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12798.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12800,meta12799__$1){
var self__ = this;
var _12800__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12798(self__.opts,self__.id,self__.fn_to_element,meta12799__$1));
}));

(reagent.impl.template.t_reagent$impl$template12798.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12800){
var self__ = this;
var _12800__$1 = this;
return self__.meta12799;
}));

(reagent.impl.template.t_reagent$impl$template12798.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12798.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12798.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12798.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12798.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta12799","meta12799",600065835,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12798.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12798.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12798");

(reagent.impl.template.t_reagent$impl$template12798.cljs$lang$ctorPrWriter = (function (this__4404__auto__,writer__4405__auto__,opt__4406__auto__){
return cljs.core._write.call(null,writer__4405__auto__,"reagent.impl.template/t_reagent$impl$template12798");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12798.
 */
reagent.impl.template.__GT_t_reagent$impl$template12798 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template12798(opts__$1,id__$1,fn_to_element__$1,meta12799){
return (new reagent.impl.template.t_reagent$impl$template12798(opts__$1,id__$1,fn_to_element__$1,meta12799));
});

}

return (new reagent.impl.template.t_reagent$impl$template12798(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
