...
var G__13338 = o;
goog.object.set(G__13338,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__13340__i < G__13340__a.length) {G__13340__a[G__13340__i] = arguments[G__13340__i + 0]; ++G__13340__i;}
  args = new cljs.core.IndexedSeq(G__13340__a,0,null);
} 
...
var G__13342 = o;
goog.object.set(G__13342,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__13344__i < G__13344__a.length) {G__13344__a[G__13344__i] = arguments[G__13344__i + 0]; ++G__13344__i;}
  args = new cljs.core.IndexedSeq(G__13344__a,0,null);
} 
...
var G__13346 = props;
var G__13346__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13346,cljs.core.cst$kw$id,id):G__13346);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13346__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4160__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__13347 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13347,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__13347;
}
})(),id_class);
...
var G__13348 = (cljs.core.count(argv) - first_child);
switch (G__13348) {
case (0):
...
break;
case (1):
var G__13349 = component;
var G__13350 = jsprops;
var G__13351 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__13349,G__13350,G__13351);
...
var vec__13353 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13353,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13353,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13353,(2),null);
...
var temp__5808__auto___13356 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___13356 == null)){
} else {
var key_13357 = temp__5808__auto___13356;
(jsprops.key = key_13357);
}
...
var temp__5808__auto___13360 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___13360 == null)){
} else {
var key_13361 = temp__5808__auto___13360;
(jsprops.key = key_13361);
}

var G__13358 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__13359 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__13358,G__13359);
});
/**
...
var temp__5808__auto___13362 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___13362 == null)){
} else {
var key_13363 = temp__5808__auto___13362;
(jsprops.key = key_13363);
}
...
var temp__5808__auto___13364 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___13364 == null)){
} else {
var key_13365 = temp__5808__auto___13364;
(jsprops.key = key_13365);
}
...
var temp__5808__auto___13366 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___13366 == null)){
} else {
var key_13367 = temp__5808__auto___13366;
(jsprops.key = key_13367);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13368_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__13368_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__13369 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13369,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13369,(1),null);
...
break;
default:
var G__13374 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__13375 = compiler;
v = G__13374;
compiler = G__13375;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template13379 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template13379 = (function (opts,id,fn_to_element,meta13380){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template13379.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13381,meta13380__$1){
var self__ = this;
var _13381__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template13379(self__.opts,self__.id,self__.fn_to_element,meta13380__$1));
}));

(reagent.impl.template.t_reagent$impl$template13379.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13381){
var self__ = this;
var _13381__$1 = this;
return self__.meta13380;
}));

(reagent.impl.template.t_reagent$impl$template13379.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template13379.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template13379.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template13379.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template13379.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$meta13380], null);
}));

(reagent.impl.template.t_reagent$impl$template13379.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template13379.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template13379");

(reagent.impl.template.t_reagent$impl$template13379.cljs$lang$ctorPrWriter = (function (this__4404__auto__,writer__4405__auto__,opt__4406__auto__){
return cljs.core._write(writer__4405__auto__,"reagent.impl.template/t_reagent$impl$template13379");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template13379.
 */
reagent.impl.template.__GT_t_reagent$impl$template13379 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template13379(opts__$1,id__$1,fn_to_element__$1,meta13380){
return (new reagent.impl.template.t_reagent$impl$template13379(opts__$1,id__$1,fn_to_element__$1,meta13380));
});

}

return (new reagent.impl.template.t_reagent$impl$template13379(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
