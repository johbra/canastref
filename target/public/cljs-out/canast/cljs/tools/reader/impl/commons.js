...
var G__13868 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__13868;
continue;
} else {
return ch;
...
var vec__13869 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__13869,(0),null);
return (match === s);
});
...
var len__4771__auto___13874 = arguments.length;
var i__4772__auto___13875 = (0);
while(true){
if((i__4772__auto___13875 < len__4771__auto___13874)){
args__4777__auto__.push((arguments[i__4772__auto___13875]));

var G__13876 = (i__4772__auto___13875 + (1));
i__4772__auto___13875 = G__13876;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq13872){
var G__13873 = cljs.core.first.call(null,seq13872);
var seq13872__$1 = cljs.core.next.call(null,seq13872);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13873,seq13872__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__13877__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__13877 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__13878__i = 0, G__13878__a = new Array(arguments.length -  1);
while (G__13878__i < G__13878__a.length) {G__13878__a[G__13878__i] = arguments[G__13878__i + 1]; ++G__13878__i;}
  _ = new cljs.core.IndexedSeq(G__13878__a,0,null);
} 
return G__13877__delegate.call(this,rdr,_);};
G__13877.cljs$lang$maxFixedArity = 1;
G__13877.cljs$lang$applyTo = (function (arglist__13879){
var rdr = cljs.core.first(arglist__13879);
var _ = cljs.core.rest(arglist__13879);
return G__13877__delegate(rdr,_);
});
