...
return ajax.formats.content_type_matches.call(null,content_type,p1__14775_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__14776){
var map__14777 = p__14776;
var map__14777__$1 = cljs.core.__destructure_map.call(null,map__14777);
var request = map__14777__$1;
var response_format = cljs.core.get.call(null,map__14777__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__14779){
var map__14780 = p__14779;
var map__14780__$1 = cljs.core.__destructure_map.call(null,map__14780);
var request = map__14780__$1;
var response_format = cljs.core.get.call(null,map__14780__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,(function (p1__14778_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__14778_SHARP_);
}),formats);
});
/**
