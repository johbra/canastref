...
var b__21987 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__21986 = (0);
while(true){
if((i__21986 < size__4563__auto__)){
var m = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4562__auto__,i__21986);
cljs.core.chunk_append(b__21987,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,cljs.core.cst$kw$height,"20px",cljs.core.cst$kw$children,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,cljs.core.cst$kw$size,"70px",cljs.core.cst$kw$child,(function (){var G__21988 = (cljs.core.key(m) - (1));
return (canastref.views.monatsnamen.cljs$core$IFn$_invoke$arity$1 ? canastref.views.monatsnamen.cljs$core$IFn$_invoke$arity$1(G__21988) : canastref.views.monatsnamen.call(null,G__21988));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21987),canastref$views$monatsbilanz_tabelle_$_iter__21984(cljs.core.chunk_rest(s__21985__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21987),null);
}
} else {
var m = cljs.core.first(s__21985__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,cljs.core.cst$kw$height,"20px",cljs.core.cst$kw$children,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,cljs.core.cst$kw$size,"70px",cljs.core.cst$kw$child,(function (){var G__21989 = (cljs.core.key(m) - (1));
return (canastref.views.monatsnamen.cljs$core$IFn$_invoke$arity$1 ? canastref.views.monatsnamen.cljs$core$IFn$_invoke$arity$1(G__21989) : canastref.views.monatsnamen.call(null,G__21989));
})()], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,cljs.core.cst$kw$size,"70px",cljs.core.cst$kw$child,cljs.core.val(m)], null)], null)], null),canastref$views$monatsbilanz_tabelle_$_iter__21984(cljs.core.rest(s__21985__$2)));
}
} else {
return null;
}
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.input_text,cljs.core.cst$kw$model,cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(canastref.spieler.resultate(tln),runde))?cljs.core.get.cljs$core$IFn$_invoke$arity$2(canastref.spieler.resultate(tln),runde):"")),cljs.core.cst$kw$on_DASH_change,(function (p1__21992_SHARP_){
var v = parseInt(p1__21992_SHARP_);
...
}),namen)),cljs.core.cst$kw$model,"?",cljs.core.cst$kw$on_DASH_change,(function (p1__21993_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$geber,namen.indexOf(p1__21993_SHARP_)], null));
})], null)], null)], null);
});
